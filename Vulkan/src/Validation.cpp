...
std::vector<const char*> Validation::getRequiredExtensions() const {
...
void Validation::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) const {
    createInfo = {};
